...
Long-term memory lets your agent store and recall information across different conversations and sessions. Unlike [short-term memory](/oss/python/langchain/short-term-memory), which is scoped to a single thread, long-term memory persists across threads and can be recalled at any time.
...
[View example traceOpen a public LangSmith run for this example.](https://smith.langchain.com/public/bce035a2-e2ac-4bd3-9ab3-53d88b16cc43/r)
...
[View example traceOpen a public LangSmith run for this example.](https://smith.langchain.com/public/477f5212-de64-4076-87d7-c4653d5c3c15/r)
