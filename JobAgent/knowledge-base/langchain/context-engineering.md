...
[System PromptBase instructions from the developer to the LLM.](#system-prompt)

[MessagesThe full list of messages (conversation history) sent to the LLM.](#messages)

[ToolsUtilities the agent has access to for taking actions.](#tools)

[ModelThe actual model (including configuration) to be called.](#model)

[Response FormatSchema specification for the model’s final response.](#response-format)
