...
[Node-style hooksRun sequentially at specific execution points.](#node-style-hooks)

[Wrap-style hooksRun around each model or tool call.](#wrap-style-hooks)
...
[Decorator-based middlewareQuick and simple for single-hook middleware. Use decorators to wrap individual functions.](#decorator-based-middleware)

[Class-based middlewareMore powerful for complex middleware with multiple hooks or configuration.](#class-based-middleware)
