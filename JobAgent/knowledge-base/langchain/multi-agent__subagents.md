...
[Migrate from langgraph-supervisorThe langgraph-supervisor package is no longer actively maintained. Learn how to migrate from create_supervisor to the subagents pattern, including interrupt and resume flows with external API callbacks.](/oss/python/migrate/langgraph-supervisor)
